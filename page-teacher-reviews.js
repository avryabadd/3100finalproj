...
function renderQuestions() {
  // Only run if we're on the page with the question list
...
document.addEventListener('DOMContentLoaded', function() {
  // Only run this code if we're on the instructor reviews page
  if (document.querySelector('#btn_add_Question')) {
    // Add a new question
...
window.editQuestion = function(index) {
  if (!document.querySelector('#txtquestion_text')) return;
